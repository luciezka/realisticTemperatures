...
public class RealisticTemperaturesModSystem : ModSystem
{
    ...
    public override void Start(ICoreAPI api)
    {
        ...
        sapi.RegisterCommand("debugwetness", "Log wetness data", "", (ServerChatCommandDelegate) ((player, group, args) =>
        {
        ...
        sapi.RegisterCommand("setWetnessClothes", "sets wetness on held item", "[wetness value]", (ServerChatCommandDelegate) ((player, group, args) =>
        {
